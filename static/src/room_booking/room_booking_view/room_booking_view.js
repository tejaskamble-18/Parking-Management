...
export class RoomBookingView extends Component {
    ...
    static props = {
        ...
        slotLocation: { type: String, optional: true },
        isEvCharger: { type: Boolean, optional: true },
        isAccessible: { type: Boolean, optional: true },
        isPremium: { type: Boolean, optional: true },
        qrDataUri: { type: String, optional: true },
    };
